...
class ContextsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create context" do
    assert_difference('Context.count') do
      post contexts_url, params: { context: { label: @context.label, platform_id: @context.platform_id, title: @context.title, type: @context.type } }
    end
  ...
  test "should update context" do
    patch context_url(@context), params: { context: { label: @context.label, platform_id: @context.platform_id, title: @context.title, type: @context.type } }
